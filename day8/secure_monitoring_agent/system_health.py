...
def get_system_health():
    ...
    print(f"Memory: Total={d['mem_total_gb']}GB, Used={d['mem_used_gb']}GB, Percent={d['mem_percent']}%")
    print(f"Disk (/): Total={d['disk_total_gb']}GB, Used={d['disk_used_gb']}GB, Percent={d['disk_percent']}%")
